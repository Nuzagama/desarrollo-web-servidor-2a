...
<body>
    ...
    */
    ...
    echo "<h3><i>Resultado 1:</i> $resultado</h3>";

    $resultado = sumaDos(3,5);
    echo "<h3><i>Resultado 2:</i> $resultado</h3>";

    // Sirve para sumar Ints y Floats
    function sumaDosV3(int|float $num1, int|float $num2){
        return $num1 + $num2;
    }

    $resultado = sumaDosV3(3,5.5);
    echo "<h3><i>Resultado 3:</i> $resultado</h3>";

    // Pase lo que pase será :float
    function sumaDosV4(int|float $num1, int|float $num2): float{
        return $num1 + $num2;
    }

    $resultado = sumaDosV4(3,3);
    echo "<h3><i>Resultado 4:</i> $resultado</h3>";
    ...
    <table>
        ...
        foreach($estudiantes as $estudiante){
            list($nombre, $p_nota) = $estudiante;
            echo "<tbody>
            <tr>
            <td>$nombre</td>
            <td>$nota</td>";
            echo "<td>" . obtenerCalificacion($p_nota) . "</td>
            </tr>
        </tbody>";
        }
    ...
    // Ingresamos un número tope a la función para buscar los primos del 2 al $numeroLimite
    function mostrarPrimos(int $numeroLimite) :array{
        $arrayPrimos = [];
    ...
    // 6 funciones para cambiar las temperaturas
    // celsiusAFarenheit
    // farenheitACelsius
    // celsiusAKelvin
    // kelvinACelsius
    ...
    */
    ...
    // Una función que reciba la temperatura, u1, u2 ejemplo (32,"C","F")
    ...
    function convertidorTemperatura(float $temperatura, string $typeOriginal, string $typeNew): string | float {
        ...
        $convert = match(true){
            ...
            default => "Podemos mandar string o float"
        };

        return $convert;
    }

    // Potencia (2,3) 2elevadoA3 = 8
    ...
    echo "<ul>
    <li>" . calcularPotencia(2,0) ."</li>
    <li>" . calcularPotencia(3,2) ."</li>
    <li>" . calcularPotencia(3,3) ."</li>
    </ul>";

    // Día 04/10/2023

    // Hacer una función que dependiendo el tipo de 
    // IVA devuelva el precio final del producto
    // IVA GENERAL => 21%
    // IVA REDUCIDO => 10%
    // IVA SUPERREDUCIDO => 4%
    // SIN IVA => 0%

    // Recibe el precio sin IVA y se lo suma
    ...
    // Recibe el precio con IVA y se lo resta
    ...
    // Ejercicio: Función que reciba salario en bruto y devuelva
    // El salario sin IRPF 30 37 45 47
